...
export const VALUATION = {
  // 만원 단위 숫자로 둔다 — 표기는 화면에서 통화에 맞춰 만든다(0.7억 = 7,000만원).
  p10: 7_000,
  p50: 45_000,
  p90: 83_000,
  lossChance: "0%",
...
export const SCENARIOS: [string, number, string][] = [
  ["비관", -24_000, "순증 2곳, 이익률 68%"],
  ["기준", 40_000, "순증 4곳, 이익률 78%"],
  ["낙관", 135_000, "순증 7곳, 이익률 85%"],
];
