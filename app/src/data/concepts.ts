...
export const CONCEPTS: Concept[] = [
  ...
  },
  {
    id: "gb",
    name: "게임보이",
    note: "네 가지 초록으로만. 실루엣이 안 살면 아무것도 안 보인다.",
  ...
  },
  {
    id: "neon",
    name: "네온 사이버펑크",
    note: "어두운 바탕에 형광 두 색. 야간 도시 배경에 얹는다.",
  ...
  },
  {
    id: "cga",
    name: "CGA 레트로",
    note: "네 색뿐인 옛 PC 화면. 일부러 촌스럽게 갈 때.",
  ...
  },
  {
    id: "one",
    name: "1비트 실루엣",
    note: "두 색만 남는다. 형태가 안 읽히면 에셋이 잘못된 것이다.",
